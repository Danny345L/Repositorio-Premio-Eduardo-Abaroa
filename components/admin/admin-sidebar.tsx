...
export function AdminSidebar({ activeSection, onNavigate, years }: AdminSidebarProps) {
  ...
  const navItems = [
    ...
    { id: "jury", label: "Jurados", icon: UserCheck },
    { id: "coordinators", label: "Coordinadores", icon: ClipboardList },
            ...
            {yearsOpen && (
              <div className="ml-7 mt-1 flex flex-col gap-0.5">
                ...
                <button
                  ...
                  className={cn(
                    "rounded-lg px-3 py-2 text-left text-xs transition-colors mt-1 border border-dashed border-border",
